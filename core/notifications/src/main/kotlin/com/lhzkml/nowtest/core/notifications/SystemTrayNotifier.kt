...
private const val TARGET_ACTIVITY_NAME = "com.lhzkml.nowtest.MainActivity"
...
private const val DEEP_LINK_SCHEME_AND_HOST = "https://www.nowtest.apps.samples.google.com"
        ...
        with(context) {
            ...
            val newsNotifications = truncatedNewsResources.map { newsResource ->
                createNewsNotification {
                    setSmallIcon(R.drawable.core_notifications_ic_nt_notification)
