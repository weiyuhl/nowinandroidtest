...
class OfflineFirstTopicsRepositoryTest {
    ...
    private lateinit var ntPreferences: NtPreferencesDataSource
    ...
    fun setup() {
        ...
        ntPreferences = NtPreferencesDataSource(InMemoryDataStore(UserPreferences.getDefaultInstance()))
        synchronizer = TestSynchronizer(ntPreferences)
