...
/**
 * nowtest filter chip with included leading checked icon as well as text content slot.
 *
    ...
    FilterChip(
        ...
        border = FilterChipDefaults.filterChipBorder(
            ...
            disabledBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = NtChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            disabledSelectedBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = NtChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            selectedBorderWidth = NtChipDefaults.ChipBorderWidth,
        ),
        colors = FilterChipDefaults.filterChipColors(
            ...
            disabledContainerColor = if (selected) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = NtChipDefaults.DISABLED_CHIP_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun ChipPreview() {
    NtTheme {
        NtBackground(modifier = Modifier.size(80.dp, 20.dp)) {
...
/**
 * nowtest chip default values.
 */
object NtChipDefaults {
    // TODO: File bug
