...
/**
 * nowtest view toggle button with included trailing icon as well as compact and expanded
...
fun NtViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = NtViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        NtViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) NtIcons.ViewDay else NtIcons.ShortText,
...
/**
 * Internal nowtest view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun NtViewToggleButtonContent(
...
/**
 * nowtest view toggle default values.
 */
object NtViewToggleDefaults {
    // TODO: File bug
