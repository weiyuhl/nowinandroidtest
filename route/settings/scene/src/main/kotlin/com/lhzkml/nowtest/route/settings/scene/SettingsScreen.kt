...
import com.lhzkml.nowtest.route.settings.scene.R.string
...
private fun SettingsToolbar(
    ...
    Row(
        ...
        Text(
            text = stringResource(string.route_settings_scene_title),
...
private fun ColumnScope.SettingsContent(
    ...
    Column(
        ...
        when (settingsUiState) {
            Loading -> {
                Text(
                    text = stringResource(string.route_settings_scene_loading),
...
private fun ColumnScope.SettingsPanel(
    ...
    SettingsSectionTitle(text = stringResource(string.route_settings_scene_dark_mode_preference))
    Column(Modifier.selectableGroup()) {
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_dark_mode_config_system_default),
            selected = settings.darkThemeConfig == FOLLOW_SYSTEM,
            onClick = { onChangeDarkThemeConfig(FOLLOW_SYSTEM) },
        )
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_dark_mode_config_light),
            selected = settings.darkThemeConfig == LIGHT,
            onClick = { onChangeDarkThemeConfig(LIGHT) },
        )
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_dark_mode_config_dark),
            selected = settings.darkThemeConfig == DARK,
            onClick = { onChangeDarkThemeConfig(DARK) },
        )
    }
    SettingsSectionTitle(text = stringResource(string.route_settings_scene_language_preference))
    Column(Modifier.selectableGroup()) {
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_language_system_default),
            selected = settings.appLanguage == AppLanguage.SYSTEM_DEFAULT,
            onClick = { onChangeLanguage(AppLanguage.SYSTEM_DEFAULT) },
        )
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_language_english),
            selected = settings.appLanguage == AppLanguage.ENGLISH,
            onClick = { onChangeLanguage(AppLanguage.ENGLISH) },
        )
        SettingsOptionRow(
            text = stringResource(string.route_settings_scene_language_simplified_chinese),
...
private fun LinksPanel() {
    FlowRow(
        ...
        TextButton(
            ...
            Text(text = stringResource(string.route_settings_scene_licenses))
        }
    }
}
