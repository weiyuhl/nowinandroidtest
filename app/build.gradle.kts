import com.lhzkml.nowtest.NtBuildType
...
dependencies {
    ...
    implementation(projects.route.test1.scene)
    implementation(projects.route.test2.contract)
    implementation(projects.route.test2.scene)
    implementation(projects.route.test3.contract)
    implementation(projects.route.test3.scene)
    implementation(projects.route.search.contract)
    implementation(projects.route.search.scene)
    implementation(projects.route.settings.contract)
    implementation(projects.route.settings.scene)
